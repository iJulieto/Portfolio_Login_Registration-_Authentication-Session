            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="navbar-brand" href="dashboard.php"><img src="images/Icon.jpg" class="img-fluid "
                                width="60" height="60" alt="Portfolio Logo"></a>
                    </li>
                </ul>
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-4">A student leader and web developer that combines leadership and technical
                        skills, inspiring peers while designing and maintaining innovative digital solutions.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-hover">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A <i class="text-decoration-underline">Learning Management System</i>
                                (LMS) is a digital platform for creating, delivering, and tracking educational content,
                                improving learning accessibility and efficiency.</p>
                            <a href="projects.php" class="btn btn-outline-dark">View Project</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card card-hover">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A <i class="text-decoration-underline">Vans Store</i> offers iconic
                                skate shoes, apparel, and accessories, featuring classic and modern styles for all ages,
                                plus exclusive collections, collaborations, and skate-inspired fashion.</p>
                            <a href="projects.php" class="btn btn-outline-dark">View Project</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card card-hover">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A <i class="text-decoration-underline">Municipal Information System</i>
                                (MIS) streamlines municipal operations, enhancing efficiency, transparency, automation,
                                data management, and citizen engagement.</p>
                            <a href="projects.php" class="btn btn-outline-dark">View Projects</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div id="developmentCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#developmentCarousel" data-bs-slide-to="0"
                        class="active"></button>
                ...
                <div class="carousel-inner">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="carousel-content text-start p-4">
                                    ...
                                    <h5><i>(2021 - 2022)</i></h5>
                                    <p class="lead">My first time of being a representative in my department of Supreme
                                        Student Council. Experienced in managing multiple projects simultaneously, from
                                        initial concept to final deployment.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <img src="images/SSC1.jpg" class="img-fluid rounded shadow-sm"
                                        alt="SSC (2022 - 2023)">
                                </div>
                                <div class="col-md-6">
                                    <div class="carousel-content text-start p-4">
                                        <h3 class="mb-3">Supreme Student Council</h3>
                                        <h5><i>(2022 - 2023)</i></h5>
                                        <p class="lead">Since my first time of being a representative in my department
                                            of Supreme Student Council, I've developed a strong communication and team
                                            management skill.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <img src="images/SSC2.jpg" class="img-fluid rounded shadow-sm"
                                        alt="SSC (2023 - 2024)">
                                </div>
                                <div class="col-md-6">
                                    <div class="carousel-content text-start p-4">
                                        <h3 class="mb-3">Supreme Student Council</h3>
                                        <h5><i>(2023 - 2024)</i></h5>
                                        <p class="lead">As I approach my 2 year mark, I find myself more confident in my
                                            abilities and a stronger connection with my peers.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="carousel-content text-start p-4">
                                        ...
                                        <h5><i>(2023)</i></h5>
                                        <p class="lead">Then, I took my first step into the world of leadership by being
                                            a representative in my department of OMPYL.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <img src="images/SSC3.jpg" class="img-fluid rounded shadow-sm"
                                        alt="SSC (2025 - Present)">
                                </div>
                                <div class="col-md-6">
                                    <div class="carousel-content text-start p-4">
                                        <h3 class="mb-3">Supreme Student Council (2024 - 2025)</h3>
                                        <h5><i>(2024 - 2025)</i></h5>
                                        <p class="lead">As of now, I find myself more confident in my abilities and a
                                            stronger connection with my peers.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#developmentCarousel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#developmentCarousel"
                        data-bs-slide="next">
